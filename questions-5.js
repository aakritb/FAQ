window.ASSUREONE_ARTICLES.push(...[
  {
    ...
    "more": [
      ...
      "Firm users can work from the shared Communications module when they want to manage conversations across multiple clients, or open a client's Communications tab when they want to begin with that client already selected. Keeping these channels connected to the client record helps the firm maintain a more complete communication history across client service, document follow-up, billing, and engagement work."
    ],
  ...
  },
  {
    ...
    "description": "A conversation can begin in the shared Communications module or in the selected client's workspace. Open Communications and choose the required channel, or open the client's Communications tab. Select…",
  ...
  },
  {
    ...
    "more": [
      "If your firm has more than one Twilio number, administrators should confirm which number is linked under Settings > Phone Numbers before telling clients which number to save or recognize. The Phone Numbers module can also show information such as SMS capability, MMS capability, voice capability, and A2P 10DLC registration status.",
    ...
    "search": "The client sees the Twilio phone number linked to your firm in AssurePro as the sender of the SMS. If your firm has more than one Twilio number, administrators should confirm which number is linked under Settings > Phone Numbers before telling clients which number to save or recognize. The Phone Numbers module can also show information such as SMS capability, MMS capability, voice capability, and A2P 10DLC registration status. For U.S. carrier messaging, confirm that the selected number has the required registration status before relying on it for regular client communication — a number may appear in the firm's configuration but still experience carrier filtering if the required messaging registration is incomplete. It is good practice to use a consistent firm number for client SMS so clients can recognize the sender and firm users can maintain a predictable communication channel.",
    "read": "2 min",
    "path": "assurepro/index.html"
  },
  {
    ...
    "title": "Calendar integrations explained",
  ...
  },
  {
    ...
    "product": "pro",
    "category": "Getting Started",
    "title": "Reports module explained",
