...
const cases=[
 ...
 ['two headers in the same module share an icon','assets/js/help-center.js',s=>s.replace("'fa-complete-your-firm-setup':'check',","'fa-complete-your-firm-setup':'settings',"),'same icon on more than one header'],
