window.ASSUREONE_ARTICLES.push(...[
  {
    ...
    "answer": "The engagement-letter builder separates the package into four connected sections so the firm can validate the client, commercial terms, agreement content, and delivery settings before sending.",
    "more": [
      "Setup answers who the client and signers are; Services & Pricing defines what is being offered and how choices work; Agreement & Terms contains the legal and supporting content; Review & Send confirms dates, reminders, billing, approvals, and unresolved requirements. The progress indicator lets staff return to an earlier section without losing the overall package context."
    ],
    "steps": [
      "Setup: select the client, name the signing package, and confirm the primary and any additional recipients.",
      "Services & Pricing: add the services, packages, add-ons, prices, discounts, billing method, and any client choices.",
      "Agreement & Terms: select or edit the agreement wording, decide whether explicit approval is required, and add supporting text, PDFs, terms, notes, payment capture, or approval automation where needed.",
      "Review & Send: confirm the recipients, sign-by and validity dates, reminder cadence, selected services, total, billing arrangement, terms, and approval requirements.",
      "Use Preview to read the package as the client will see it and correct any unclear wording or choices.",
      "Resolve every item in the missing-requirements list; Send remains unavailable until the required client, package, recipient, service, and agreement information is complete."
    ],
    "search": "The engagement-letter builder separates the package into four connected sections so the firm can validate the client, commercial terms, agreement content, and delivery settings before sending. Setup answers who the client and signers are; Services & Pricing defines what is being offered and how choices work; Agreement & Terms contains the legal and supporting content; Review & Send confirms dates, reminders, billing, approvals, and unresolved requirements. The progress indicator lets staff return to an earlier section without losing the overall package context. Setup: select the client, name the signing package, and confirm the primary and any additional recipients. Services & Pricing: add the services, packages, add-ons, prices, discounts, billing method, and any client choices. Agreement & Terms: select or edit the agreement wording, decide whether explicit approval is required, and add supporting text, PDFs, terms, notes, payment capture, or approval automation where needed. Review & Send: confirm the recipients, sign-by and validity dates, reminder cadence, selected services, total, billing arrangement, terms, and approval requirements. Use Preview to read the package as the client will see it and correct any unclear wording or choices. Resolve every item in the missing-requirements list; Send remains unavailable until the required client, package, recipient, service, and agreement information is complete.",
    "read": "2 min",
  ...
  },
  {
    ...
    "answer": "The builder prevents sending until its required client, package, recipient, and service information is complete.",
    "steps": [
      "Open Engagement Letter and start a new Engagement Letter.",
      "Start from scratch or choose a saved or curated template.",
      "In Setup, select the client, name the package, and confirm the primary and any additional recipients.",
      "Add Services & Pricing and choose how each service is presented to the client.",
      "Configure Agreement & Terms, including approval requirements and supporting content.",
      "Preview the client experience.",
      "In Review & Send, set the sign-by date, validity date, reminders, and other package details.",
      "Resolve every missing requirement and select Send package."
    ],
    "search": "The builder prevents sending until its required client, package, recipient, and service information is complete. Open Engagement Letter and start a new Engagement Letter. Start from scratch or choose a saved or curated template. In Setup, select the client, name the package, and confirm the primary and any additional recipients. Add Services & Pricing and choose how each service is presented to the client. Configure Agreement & Terms, including approval requirements and supporting content. Preview the client experience. In Review & Send, set the sign-by date, validity date, reminders, and other package details. Resolve every missing requirement and select Send package.",
    "read": "2 min",
    "path": "assurepro/index.html"
  },
  {
    ...
    "answer": "Engagement letters are currently created and sent as client-specific signing packages; the Engagement Letter screen does not provide a bulk-create or bulk-send action. This keeps each package tied to the correct client, recipients, services, pricing, terms, and signature requirements.",
    "more": [
      "For example, a firm preparing annual tax packages can save one approved tax template and reuse it across clients, while still checking each client's entity, recipients, selected services, price, due dates, and billing schedule before sending. This provides consistency without treating client-specific agreements as an undifferentiated bulk message."
    ],
    "steps": [
      "Open Engagement Letters and select New signing package.",
      "Choose the client and add the required recipients.",
      "Build the letter from scratch, a firm template, or a curated template.",
      "Review the services, pricing, billing schedule, terms, and signature fields for that client.",
      "Send the package and monitor its status from Engagement Letters.",
      "Repeat the package flow for the next client; reusable templates reduce repeated drafting even though sending remains client-specific."
    ],
    "search": "Engagement letters are currently created and sent as client-specific signing packages; the Engagement Letter screen does not provide a bulk-create or bulk-send action. This keeps each package tied to the correct client, recipients, services, pricing, terms, and signature requirements. For example, a firm preparing annual tax packages can save one approved tax template and reuse it across clients, while still checking each client's entity, recipients, selected services, price, due dates, and billing schedule before sending. This provides consistency without treating client-specific agreements as an undifferentiated bulk message. Open Engagement Letters and select New signing package. Choose the client and add the required recipients. Build the letter from scratch, a firm template, or a curated template. Review the services, pricing, billing schedule, terms, and signature fields for that client. Send the package and monitor its status from Engagement Letters. Repeat the package flow for the next client; reusable templates reduce repeated drafting even though sending remains client-specific.",
    "read": "2 min",
    "path": "assurepro/index.html"
  },
  {
    ...
    "answer": "Services & Pricing supports three structures: Client picks one for choose-one packages, Client can add it for optional add-ons, and No client choice for services that are always included. The builder also supports billing software as part of the package.",
    "more": [
      "Use Client picks one when packages are mutually exclusive, such as Basic, Standard, and Premium; Client can add it for optional items such as audit protection or an advisory consultation; and No client choice for a service that must always be included. Preview the package to confirm the client's choices and total are understandable before sending."
    ],
    "search": "Services & Pricing supports three structures: Client picks one for choose-one packages, Client can add it for optional add-ons, and No client choice for services that are always included. The builder also supports billing software as part of the package. Use Client picks one when packages are mutually exclusive, such as Basic, Standard, and Premium; Client can add it for optional items such as audit protection or an advisory consultation; and No client choice for a service that must always be included. Preview the package to confirm the client's choices and total are understandable before sending.",
    "read": "2 min",
    "path": "assurepro/index.html"
  },
  {
    ...
    "answer": "Yes. After selecting the client in Setup, confirm the primary recipient and use Add additional recipient for every other required signer. Review each recipient's name and email before sending, then confirm the package's signing mode and recipient summary in Review & Send. After delivery, the package status can distinguish a partially signed package from one completed by all required recipients.",
    "more": [
      "For example, a business package can include an owner as primary recipient and a second authorized signer. If only one signer completes their part, the package remains Partial; staff can use the status and recipient detail to follow up with the outstanding signer rather than resending the entire package blindly."
    ],
    "search": "Yes. After selecting the client in Setup, confirm the primary recipient and use Add additional recipient for every other required signer. Review each recipient's name and email before sending, then confirm the package's signing mode and recipient summary in Review & Send. After delivery, the package status can distinguish a partially signed package from one completed by all required recipients. For example, a business package can include an owner as primary recipient and a second authorized signer. If only one signer completes their part, the package remains Partial; staff can use the status and recipient detail to follow up with the outstanding signer rather than resending the entire package blindly.",
    "read": "2 min",
    "path": "assurepro/index.html"
  },
  {
    ...
    "answer": "Yes. A package can include an introduction with a selected or custom message. Agreement & Terms uses a terms template, can require explicit approval before signing, and can add supporting material such as text pages, PDFs, extra terms, notes, payment capture, or approval automation.",
    "more": [
      "Use the introduction to explain the relationship in plain language and the terms template for the formal agreement. Supporting pages can add a PDF, extra terms, firm notes, payment capture, or approval automation; preview the combined package so optional content does not contradict the selected services, pricing, dates, or approval rule."
    ],
    "search": "Yes. A package can include an introduction with a selected or custom message. Agreement & Terms uses a terms template, can require explicit approval before signing, and can add supporting material such as text pages, PDFs, extra terms, notes, payment capture, or approval automation. Use the introduction to explain the relationship in plain language and the terms template for the formal agreement. Supporting pages can add a PDF, extra terms, firm notes, payment capture, or approval automation; preview the combined package so optional content does not contradict the selected services, pricing, dates, or approval rule.",
    "read": "2 min",
    "path": "assurepro/index.html"
  },
  {
    ...
    "answer": "Review & Send summarizes the client, package name, recipients, sign-by date, validity date, reminder cadence, billing, terms, and approval requirement. The builder lists each unresolved requirement and keeps Send disabled until required items are resolved.",
    "more": [
